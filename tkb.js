...
var data2 = [ 
  {"ma": 'SK460', "ten": ' Thực tập ngành công tác xã hội', "lop": 'TTTOTNGHIEPCTXH.1', "thu": '1', "ca": '1-5',"PHONG": "A705",
    "SOTIN": "3","GIANGVIEN": "PHAN NGỌC MINH(CTM040)"}
  ,
  {"ma": 'AD206', "ten": 'Ẩm thực Việt Nam', "lop": 'AM"THU"CVN.2.1_BT', "thu": '2', "ca": '1-5',"PHONG": "A705",
    "SOTIN": "3","GIANGVIEN": "PHAN NGỌC MINH(CTM040)"}
  ,
  {"ma": 'AD206', "ten": 'Ẩm thực Việt Nam', "lop": 'AM"THU"CVN.2.2_BT',"thu": '4', "ca": '1-5',"PHONG": "A705",
    "SOTIN": "3","GIANGVIEN": "PHAN NGỌC MINH(CTM040)"}
  ,
  {"ma": 'IS345', "ten": 'An toàn thông tin', "lop": 'ANTOANTTIN.1', "thu": '5', "ca": '1-5',"PHONG": "A705",
    "SOTIN": "3","GIANGVIEN": "PHAN NGỌC MINH(CTM040)"}
  ,
  {"ma": 'IS345', "ten": 'An toàn thông tin', "lop": 'ANTOANTTIN.2', "thu": '6', "ca": '1-5',"PHONG": "A705",
    "SOTIN": "3","GIANGVIEN": "PHAN NGỌC MINH(CTM040)"}
  ,
  {"ma": 'IS345', "ten": 'An toàn thông tin', "lop": 'ANTOANTTIN.1', "thu": '7', "ca": '1-5',"PHONG": "A705",
    "SOTIN": "3","giangvien": "Ngô Khánh Huyền(CQB002)"}
  ,
...
function displayData() {
    ...
    tableBody.innerHTML = ''; // Xóa dữ liệu cũ khi chọn lựa chọn mới
    ...
    // Hiển thị dữ liệu tương ứng với lựa chọn
    for (var i = 0; i < dataToDisplay.length; i++) {
      var row = document.createElement('tr');

      var cellIndex = document.createElement('td');
      cellIndex.textContent = i + 1; // Số thứ tự bắt đầu từ 1
...
function searchSJ() {
  var input, filter, table, tbody, tr, td, i, j, txtValue;
    ...
    for (i = 0; i < tr.length; i++) {
        ...
        var found = false; // Biến để kiểm tra nếu có kí tự 'filter' tại ít nhất một cột trong hàng

        for (j = 0; j < td.length; j++) {
            if (td[j]) {
                txtValue = td[j].textContent || td[j].innerText;
                if (txtValue.toUpperCase().indexOf(filter) === 0) { // So sánh với từ đầu tiên
                    found = true;
                }
            }
        }
        ...
        if (found) {
            tr[i].style.display = ''; // Hiển thị hàng nếu có kí tự filter ở đầu tiên
        } else {
