$(function (){
    ...
    function ktNgaySinh() {
        ...
        if (eval(today.getFullYear()-ns.getFullYear())<=22) {
            $("#tbNgaySinh").html("Sinh viên phải ít nhất là 22 tuổi");
            return false;
        }
        $("#tbNgaySinh").html("");
        return true;
	...
	function updateInfo(){
		if(ktHoTen()==false || ktDiaChi()==false || ktNgaySinh()==false || ktNoiSinh()==false || ktEmail()== false){
